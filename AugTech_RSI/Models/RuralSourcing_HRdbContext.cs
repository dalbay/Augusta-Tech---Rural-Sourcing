...
namespace AugTech_RSI.Models
{
    public partial class RuralSourcing_HRdbContext : DbContext
    {
        ...
        public RuralSourcing_HRdbContext(DbContextOptions<RuralSourcing_HRdbContext> options) : base (options)
        {
...
//                optionsBuilder.UseSqlServer(@"Data Source=DESKTOP-AYGUN;Initial Catalog=RuralSourcing_HRdb;Integrated Security=True;");
//            }
//        }
